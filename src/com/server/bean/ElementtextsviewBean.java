 ...
 *@author ZhangRuiLong
 */
public class ElementtextsviewBean
{
   /**
    * ,主键
    */
    ...
    * 
    */
   private ArrayList<Elementtextsview> elementtexts;  
    //属性方法	    
     /**
	 *设置主键""属性
	 *@param id 实体的Id属性
	...
	public ArrayList<Elementtextsview> getElementtexts() {
		return elementtexts;
	}

	public void setElementtexts(ArrayList<Elementtextsview> elementtexts) {
